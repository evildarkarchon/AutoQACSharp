...
public interface IGameSpecificDetector
{
    ...
    /// </summary>
    /// <param name="plugin">
    ///     The plugin to scan. It should match one of <see cref="SupportedReleases" />; implementations throw
    ///     if the supplied mod type is incompatible.
    /// </param>
    /// <param name="ct">Cancellation token checked during record traversal.</param>
    ...
    /// </summary>
    /// <param name="plugin">
    ///     The plugin to scan. It should match one of <see cref="SupportedReleases" /> when the game has
    ///     navmeshes; implementations for games without navmeshes may simply return an empty sequence.
    /// </param>
    /// <param name="ct">Cancellation token checked during record traversal.</param>
