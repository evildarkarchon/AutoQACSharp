...
public sealed class LoadOrderConfig
{
    ...
    public LoadOrderConfig Copy()
    {
        return new LoadOrderConfig { File = File };
    }
}
...
public sealed class ModOrganizerConfig
{
    ...
    public ModOrganizerConfig Copy()
    {
        return new ModOrganizerConfig { Binary = Binary };
    }
}
...
public sealed class XEditConfig
{
    ...
    public XEditConfig Copy()
    {
        return new XEditConfig { Binary = Binary };
    }
}
...
public sealed class AutoQacSettings
{
    ...
    public AutoQacSettings Copy()
    {
        return new AutoQacSettings
        {
