...
{
    [YamlMember(Alias = "AutoQAC_Data")] public AutoQacData Data { get; set; } = new();
}
...
public sealed class AutoQacData
{
    ...
    [YamlMember(Alias = "XEdit_Lists")] public Dictionary<string, List<string>> XEditLists { get; set; } = new();
