...
public static class StopTerminationDialogContent
{
    ...
    /// </summary>
    public const string ConfirmationMessage = "xEdit did not exit after the stop request. AutoQAC can leave xEdit running, or force terminate it now. Force terminating can interrupt remaining file or log writes.";
