...
public interface IBackupSessionCoordinator
{
    ...
    ///     Thrown when <paramref name="sessionToken" /> is canceled before session
    ///     creation.
    /// </exception>
    ...
    /// <exception cref="OperationCanceledException">
    ///     May be thrown for unexpected cancellation outside expected backup-result
    ///     cancellation.
    /// </exception>
    ...
    /// <param name="ct">
    ///     Cancellation token for the metadata write; callers may pass <see cref="CancellationToken.None" /> for
    ///     best effort.
    /// </param>
