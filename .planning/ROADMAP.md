...
- [ ] **Phase 11: User-Facing Diagnostics Boundaries** - Users see concise errors while logs avoid unnecessary path and command exposure. (gaps planned 2026-05-01) (completed 2026-05-01) (additional gap planned 2026-05-01)
...
- [ ] 11-10-PLAN.md — Close CleaningService raw plugin-filename failed-message source boundary gap (SEC-01)
...
| 11. User-Facing Diagnostics Boundaries | v1.0 Cleanup | 9/10 | Gaps planned | - |
