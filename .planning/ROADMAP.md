...
- [ ] 07-12-PLAN.md — Close normal progress window result close and ViewModel disposal lifecycle gap.
- [ ] 07-13-PLAN.md — Close RestoreWindow Delete Session backup-root containment gap.
**UI hint**: yes
...
| 7. Backup Restore & Retention Safety | v1.0 Cleanup | 11/13 | Gaps planned | - |
