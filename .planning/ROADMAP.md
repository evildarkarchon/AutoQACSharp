...
- [ ] **Phase 11: User-Facing Diagnostics Boundaries** - Users see concise errors while logs avoid unnecessary path and command exposure. (gaps planned 2026-05-01)
...
- [ ] 11-07-PLAN.md — Close legacy migration warning raw exception disclosure gap (SEC-01)
...
| 11. User-Facing Diagnostics Boundaries | v1.0 Cleanup | 6/9 | Gaps planned | - |
