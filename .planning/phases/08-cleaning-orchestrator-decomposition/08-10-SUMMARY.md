...
plan: 10
subsystem: cleaning-preflight
tags: [csharp, dotnet, tdd, load-order, game-detection]
requires:
  - phase: 08-cleaning-orchestrator-decomposition
    provides: extracted CleaningPreflight collaborator
provides:
...
affects: [cleaning-preflight, game-detection, load-order-validation]
tech-stack:
  added: []
  patterns: [post-detection validation, TDD regression]
key-files:
  created: []
  modified:
...
key-decisions:
  - "File-load-order policy remains local to CleaningPreflight for Phase 8; consolidation remains deferred to REF-02/Phase 9."
patterns-established:
  - "Validate Unknown-derived game requirements immediately after final detection and before skip-list/plugin-row construction."
