...
tags: [dotnet, processstartinfo, argumentlist, xedit, mo2, testing]

# Dependency graph
requires:
  - phase: 05-process-stop-pid-safety
    provides: sequential process execution and stop/PID safety baseline
provides:
...
affects: [process-execution, cleaning-service, command-launch-escaping]

# Tech tracking
tech-stack:
  added: []
  patterns:
    - ProcessStartInfo.ArgumentList for direct process argv boundaries
    - CRT-style quote/backslash formatting only for MO2's nested -a parser boundary
