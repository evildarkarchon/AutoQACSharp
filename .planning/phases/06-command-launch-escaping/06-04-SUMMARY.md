...
plan: 04
subsystem: cleaning
tags: [xedit, mo2, process-launch, diagnostics, tests]
requires:
  - phase: 06-command-launch-escaping
    provides: Direct and MO2 ArgumentList launch contracts plus safe command-build failure handling.
provides:
...
affects: [phase-06, phase-11, cleaning, diagnostics]
tech-stack:
  added: []
  patterns:
    - TDD red/green gap-closure commits.
    - User-facing launch failures omit configured executable paths and raw command fragments.
key-files:
  created: []
  modified:
